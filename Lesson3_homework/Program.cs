...
it was the grayish white of old porridge.";
            ...
            delkaTextu = ocistenyText.Length;
            ...
            piseSeOMarge = text.Contains("Marge"); // Vlastní jméno musí být velkým písmenem na začátku.
            ...
            jeSpravneUkoncen = posledniZnak == '.' || posledniZnak == '!' || posledniZnak == '?';
            ...
            veta = oseknutyZbytekTextu.Substring(poziceZacatkuVety);
